...
<%@ page import="com.kosa.mvc2.board.*"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
      ...
      <tr>
        ...
        <td>
        	 <div class="input-group">
			    ...
			    name="title" id="title" value="<%=dto.getB_b_title()%>">
			 </div>
        </td>
      </tr>
      <tr>
        ...
        <td>
        	 <div class="input-group">
        	 	<input type="hidden" name="writer" id="writer" value="<%=session.getAttribute("b_m_userid")%>">
			    <input type="text" class="form-control" placeholder="이름을 입력하세요"
			    name="b_m_name" id="b_m_name" value="<%=session.getAttribute("b_m_name")%>">
			 </div>
        </td>
      </tr>
      <tr>
        ...
        <td>
        	 <div class="input-group">
			    ...
			    name="b_b_contents" id="b_b_contents" rows="5"><%=dto.getB_b_contents()%></textarea>
			 </div>
        </td>
      </tr>
      <tr>
        ...
        <td>
        	 <div class="input-group">
			    <input type="file" class="form-control" placeholder="이미지를 선택하세요" name="b_b_image" id="b_b_image">
			 </div>
        </td>
      </tr>
    </tbody>
	...
	$("#btnSave").click(()=>{
		...
		.done((response)=>{
			...
			if(response.result=="success"){
				alert("새 글이 등록되었습니다.");
				location.href="<%=CONTEXT%>/board.do?cmd=list&pg=0";
			}
		})
