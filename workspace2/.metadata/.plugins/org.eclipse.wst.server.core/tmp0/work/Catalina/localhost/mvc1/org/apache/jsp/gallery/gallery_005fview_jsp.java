 ...
 * Generated at: 2023-01-18 08:19:42 UTC
...
import java.util.*;
import com.kosa.mvc1.gallery.*;

public final class gallery_005fview_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_packages.add("com.kosa.mvc1.gallery");
...
String CONTEXT = request.getContextPath();
      ...
      out.write("      </tr>\r\n");
      out.write("      <tr>\r\n");
      out.write("        <th colspan=\"10\">내용</th>\r\n");
      out.write("      </tr>\r\n");
      out.write("      <tr>\r\n");
      out.write("        <!-- 칸 깨지지 않게 하기 -->\r\n");
      out.write("        <td colspan=\"10\" style=\"word-break:break-all\">\r\n");
      out.write("        	<img src=\"");
      out.print(CONTEXT);
      out.write("/upload/gallery/");
      out.print(dto.getImage());
      out.write("\"  style=\"width:100%\">\r\n");
      out.write("	        </td>   \r\n");
      out.write("		</tr>\r\n");
      out.write("		<tr>\r\n");
      out.write("	        <td colspan=\"10\" style=\"word-break:brea-all\">\r\n");
      out.write("        	 ");
...
if(dto.getWriter().equals(session.getAttribute("m_userid"))) { 
      out.write("\r\n");
      out.write("	<!-- session.getAttribute의 값이 null이면 equals 호출을 할 수 없기 때문에 dto.getWriter()가 앞으로 와야 함\r\n");
      out.write("	해당 글을 쓴 회원이 아닐 경우 수정, 삭제를 할 수 없도록 -->\r\n");
      out.write("	<!-- 만약 이 동작이 수행된다면 button 객체가 생성되지 않아 아래 자바 스크립트에 에러가 발생할 수 있으므로\r\n");
      out.write("	밑에서도 addEventListener 메소드에 if문을 적용시켜줘야 한다 -->\r\n");
